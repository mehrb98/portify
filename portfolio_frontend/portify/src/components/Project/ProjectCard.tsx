...
export default function ProjectCard({props}: {props: IProjectCard}) {
   ...
   return (
      <Link href={`/projects/${props.slug}`} className="h-full">
         <div 
            className="group relative flex h-full flex-col overflow-hidden rounded-xl border
            border-gray-800 bg-gray-900/50 shadow-lg backdrop-blur-sm transition-all 
         ...
         >
            <div className="relative h-60 w-full overflow-hidden bg-gray-800">
               <Image
                  ...
                  src={imageError ? '/placeholder-project.jpg' : props.imageUrl}
            ...
            <div className="flex h-full flex-col justify-between gap-4 p-6">
               <div>
                  <h3 className="mb-2 text-xl font-bold text-gray-100">{props.title}</h3>
